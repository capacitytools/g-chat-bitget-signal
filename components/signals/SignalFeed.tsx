...
import { FeedSignalCard } from "@/components/signals/FeedSignalCard";
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-20">
      ...
      {closedSignals.length > 0 && (
        <div className="px-4 pb-4">
          <h2 className="text-sm font-bold text-gray-900 dark:text-white mb-3">Recent Results ({closedSignals.length})</h2>
