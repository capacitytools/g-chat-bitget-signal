...
function FeedSignalCard({ signal }: { signal: FeedSignal }) {
  ...
  return (
    <div className={`border-2 rounded-xl p-4 min-w-[320px] max-w-[340px] flex-shrink-0 transition-all ${
      isExpired
      ...
      {/* BIG Countdown Timer */}
      {!isExpired && (
        <div className="bg-gradient-to-r from-yellow-400 to-orange-500 rounded-xl p-3 mb-3 text-center">
          <div className="flex items-center justify-center gap-2 mb-1">
            <Timer className="w-5 h-5 text-white animate-pulse" />
            <span className="text-xs font-bold text-white uppercase">Time Remaining</span>
          </div>
      ...
      {!isExpired && (
        <div className="grid grid-cols-2 gap-2 mb-3">
          ...
          <div className={`rounded-lg p-2 text-center ${
            ...
            <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-1">Live P/L</p>
      ...
      {/* Expired Result */}      {isExpired && (
        <div className={`rounded-xl p-4 mb-3 text-center ${
          ...
          <div className="flex items-center justify-center gap-2 mb-2">
            {isWin ? <CheckCircle className="w-6 h-6 text-white" /> : <XCircle className="w-6 h-6 text-white" />}
