          ...
          <div className="grid grid-cols-3 gap-2">
            <div>
              ...
              <input 
                ...
                className="w-full p-1.5 text-xs bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded" 
              />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full p-1.5 text-xs bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-900/50 rounded text-red-700 dark:text-red-300" 
              />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full p-1.5 text-xs bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-900/50 rounded text-green-700 dark:text-green-300" 
              />
            </div>
          </div>
